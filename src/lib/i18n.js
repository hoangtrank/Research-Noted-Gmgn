...
(() => {
  ...
  const en = {
    ...
    panel_empty_2: 'This panel sits outside the page, so it never covers gmgn. Drag its edge to resize.', ext_reloaded: 'Research-Noted-Gmgn was updated. Reload this page to keep using it.', gmgn_new: 'New to gmgn.ai? Open it here',
  ...
  const vi = {
    ...
    panel_empty_2: 'Panel này nằm ngoài trang nên không che gmgn. Kéo mép để đổi độ rộng.', ext_reloaded: 'Research-Noted-Gmgn vừa được cập nhật. Tải lại trang này để dùng tiếp.', gmgn_new: 'Chưa biết gmgn.ai là gì? Mở tại đây',
  ...
  const zh = {
    ...
    panel_empty_2: '此面板位于页面之外，不会遮挡 gmgn。拖动边缘可调整宽度。', ext_reloaded: 'Research-Noted-Gmgn 已更新，请刷新此页面后继续使用。', gmgn_new: '还不了解 gmgn.ai？从这里打开',
