...
(() => {
  ...
  const en = {
    ...
    follow_page: 'Side panel follows the token you open (gmgn, DexScreener)',
    x_onboard: 'Research-Noted-Gmgn is on X: click the ✎ button under a post to save it into a project. For a screenshot, right-click the post → "Save post with screenshot", or press Alt+S while hovering it.', got_it: 'Got it',
    x_pick: 'Save this post to', x_suggested: 'Suggested', x_search_ph: 'Search project…', x_screenshot: 'Include screenshot', x_type: 'Entry type',
    x_saved: 'Saved to {symbol}', x_saved_btn: 'Saved to {symbol} — click to save again', x_btn: 'Save this post to a note', x_no_projects: 'No notes yet. Create one on gmgn or DexScreener first.',
    x_shot_hint: 'Screenshots need a user gesture: right-click the post → "Save post with screenshot", or press Alt+S while hovering it.',
    x_shot_failed: 'Saved text only (screenshot not allowed here). Right-click the post or press Alt+S to include one.', x_menu: 'Save post with screenshot to Research-Noted-Gmgn',
    x_screenshot_setting: 'Take a screenshot when saving an X post (when allowed)', export_images: 'Include screenshots in JSON export', open_image: 'Open image', image_alt: 'Screenshot',
    grok_auto_setting: 'Auto-save Grok answers into the timeline (tabs opened from a note)', grok_auto: 'Auto-save answers', grok_autosaved: 'Auto-saved to {symbol}', undo: 'Undo', grok_undone: 'Removed', grok_dup: 'Already saved',
  ...
  const vi = {
    ...
    follow_page: 'Side panel tự chuyển theo token đang mở (gmgn, DexScreener)',
    x_onboard: 'Research-Noted-Gmgn đang chạy trên X: bấm nút ✎ dưới mỗi bài để lưu vào dự án. Muốn kèm ảnh chụp: chuột phải vào bài → "Save post with screenshot", hoặc Alt+S khi rê chuột lên bài.', got_it: 'Đã hiểu',
    x_pick: 'Lưu bài này vào', x_suggested: 'Gợi ý', x_search_ph: 'Tìm dự án…', x_screenshot: 'Kèm ảnh chụp', x_type: 'Loại mốc',
    x_saved: 'Đã lưu vào {symbol}', x_saved_btn: 'Đã lưu vào {symbol} — bấm để lưu thêm', x_btn: 'Lưu bài này vào ghi chú', x_no_projects: 'Chưa có ghi chú nào. Tạo trước trên gmgn hoặc DexScreener.',
    x_shot_hint: 'Chụp ảnh cần thao tác gọi extension: chuột phải vào bài → "Save post with screenshot", hoặc Alt+S khi rê chuột lên bài.',
    x_shot_failed: 'Chỉ lưu được chữ (chưa được phép chụp ảnh ở đây). Chuột phải vào bài hoặc bấm Alt+S để kèm ảnh.', x_menu: 'Lưu bài kèm ảnh chụp vào Research-Noted-Gmgn',
    x_screenshot_setting: 'Chụp ảnh khi lưu bài trên X (khi được phép)', export_images: 'Kèm ảnh chụp khi xuất JSON', open_image: 'Mở ảnh', image_alt: 'Ảnh chụp',
    grok_auto_setting: 'Tự lưu câu trả lời của Grok vào timeline (tab mở từ ghi chú)', grok_auto: 'Tự lưu câu trả lời', grok_autosaved: 'Đã tự lưu vào {symbol}', undo: 'Hoàn tác', grok_undone: 'Đã gỡ', grok_dup: 'Đã lưu trước đó',
  ...
  const zh = {
    ...
    follow_page: '侧边栏跟随当前打开的代币（gmgn、DexScreener）',
    x_onboard: 'Research-Noted-Gmgn 已在 X 上运行：点击帖子下方的 ✎ 按钮即可保存到项目。要附带截图，请右键帖子 →「Save post with screenshot」，或将鼠标悬停在帖子上按 Alt+S。', got_it: '知道了',
    x_pick: '把这条帖子保存到', x_suggested: '推荐', x_search_ph: '搜索项目…', x_screenshot: '附带截图', x_type: '记录类型',
    x_saved: '已保存到 {symbol}', x_saved_btn: '已保存到 {symbol} — 点击可再次保存', x_btn: '把这条帖子保存到笔记', x_no_projects: '还没有笔记。请先在 gmgn 或 DexScreener 上创建。',
    x_shot_hint: '截图需要用户手势：右键帖子 →「Save post with screenshot」，或将鼠标悬停在帖子上按 Alt+S。',
    x_shot_failed: '仅保存了文字（此处暂不允许截图）。右键帖子或按 Alt+S 可附带截图。', x_menu: '带截图保存帖子到 Research-Noted-Gmgn',
    x_screenshot_setting: '保存 X 帖子时截图（在允许时）', export_images: '导出 JSON 时包含截图', open_image: '打开图片', image_alt: '截图',
    grok_auto_setting: '自动把 Grok 的回答保存到时间线（从笔记打开的标签页）', grok_auto: '自动保存回答', grok_autosaved: '已自动保存到 {symbol}', undo: '撤销', grok_undone: '已移除', grok_dup: '之前已保存',
