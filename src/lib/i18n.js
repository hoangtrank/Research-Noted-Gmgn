...
(() => {
  ...
  const en = {
    ...
    panel_empty_2: 'This panel sits outside the page, so it never covers gmgn. Drag its edge to resize.', backups: 'Automatic backups (taken before an import or a sync changes your notes)', backup_none: 'No backup yet', backup_restore: 'Restore', backup_item: '{when} · {n} projects · before {reason}', backup_r_import: 'import', backup_r_sync: 'sync', backup_r_restore: 'a restore', backup_confirm: 'Replace ALL current notes with this backup? The current notes are backed up first, so you can undo this.', backup_done: 'Restored {n} projects.', ext_reloaded: 'Research-Noted-Gmgn was updated. Reload this page to keep using it.', gmgn_new: 'New to gmgn.ai? Open it here',
  ...
  const vi = {
    ...
    panel_empty_2: 'Panel này nằm ngoài trang nên không che gmgn. Kéo mép để đổi độ rộng.', backups: 'Bản sao lưu tự động (chụp trước khi import hoặc sync làm thay đổi ghi chú)', backup_none: 'Chưa có bản sao lưu nào', backup_restore: 'Khôi phục', backup_item: '{when} · {n} dự án · trước khi {reason}', backup_r_import: 'import', backup_r_sync: 'sync', backup_r_restore: 'khôi phục', backup_confirm: 'Thay TOÀN BỘ ghi chú hiện tại bằng bản sao lưu này? Ghi chú hiện tại được sao lưu trước, nên bạn vẫn quay lại được.', backup_done: 'Đã khôi phục {n} dự án.', ext_reloaded: 'Research-Noted-Gmgn vừa được cập nhật. Tải lại trang này để dùng tiếp.', gmgn_new: 'Chưa biết gmgn.ai là gì? Mở tại đây',
